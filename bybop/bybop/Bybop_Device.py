...
class JumpingSumo(Device):
    ...
    def jump_load(self):
        """
        Make the JumpingSumo jump load.
        """
        return self.send_data('jpsumo.Animations.JumpLoad')

    def jump_cancel(self):
        """
        Make the JumpingSumo jump cancel.
        """
        return self.send_data('jpsumo.Animations.JumpCancel')

    def jump_stop(self):
        """
        Make the JumpingSumo jump stop emergency.
        """
        return self.send_data('jpsumo.Animations.JumpStop')

    def move(self, speed, turn):
        """
        Make the JumpingSumo move.
        - speed : -100 to 100
        - turn : -100 to 100
        """
        return self.send_data('jpsumo.Piloting.PCMD', True, speed, turn)
    ...
    def simple_animation(self, animation_type):
        ...
        :return: 
        """
        return self.send_data('jpsumo.Animations.SimpleAnimation', animation_type)
